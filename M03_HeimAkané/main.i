...
extern const unsigned short trialMapMap[1024];
# 22 "main.c" 2
# 1 "trial.h" 1
...
void goToStart() {
    ...
    shadowOAM[staminaBar.oamIndex].attr0 = (2<<8);
...
void pause() {
    waitForVBlank();
    if ((!(~(oldButtons) & ((1<<3))) && (~(buttons) & ((1<<3)))) && prevState == GAME) {
        goToGame();
    }
    if ((!(~(oldButtons) & ((1<<3))) && (~(buttons) & ((1<<3)))) && prevState == SPRING) {
        goToSpring();
    }
    if ((!(~(oldButtons) & ((1<<3))) && (~(buttons) & ((1<<3)))) && prevState == TRIAL) {
        goToTrial();
    }
}
...
void goToTrial() {
    DMANow(3, springTiles, &((CB*) 0x6000000)[0], 8192 / 2);
    DMANow(3, trialMapMap, &((SB*) 0x6000000)[8], (2048) / 2);
    DMANow(3, springPal, ((unsigned short *)0x5000000), 512 / 2);
