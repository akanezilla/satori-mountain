...
void drawPlayer() {
    if (player.active && !hasArmor) {
        ...
        shadowOAM[player.oamIndex].attr0 = ((player.y - vOff) & 0xFF) | (0<<8) | (2<<14);
        shadowOAM[player.oamIndex].attr1 = ((player.x - hOff) & 0x1FF) | (2<<14);
        shadowOAM[player.oamIndex].attr2 = (((7) & 0xF) <<12) | ((((player.direction * 4) * (32) + (6 + (player.currentFrame * 2)))) & 0x3FF);
        (*(volatile unsigned short*) 0x04000010) = hOff;
        (*(volatile unsigned short*) 0x04000012) = vOff;
    } else {
...
void drawSpiritOrb() {
    ...
    if (spiritOrb1.active) {
        ...
        if (screenY > 160 || screenX > 240 || screenY < -spiritOrb1.height || screenX < -spiritOrb1.width) {
            ...
            shadowOAM[spiritOrb1.oamIndex].attr2 = (((2) & 0xF) <<12) | ((((0) * (32) + (23))) & 0x3FF);
        }
    } else {
        shadowOAM[spiritOrb1.oamIndex].attr0 = (2<<8);
    }
    ...
    if (spiritOrb2.active) {
        ...
        if (screenY > 160 || screenX > 240 || screenY < -spiritOrb2.height || screenX < -spiritOrb2.width) {
            ...
            shadowOAM[spiritOrb2.oamIndex].attr2 = (((2) & 0xF) <<12) | ((((0) * (32) + (23))) & 0x3FF);
        }
    } else {
        shadowOAM[spiritOrb2.oamIndex].attr0 = (2<<8);
    }
    ...
    if (spiritOrb3.active) {
        ...
        if (screenY > 160 || screenX > 240 || screenY < -spiritOrb3.height || screenX < -spiritOrb3.width) {
            ...
            shadowOAM[spiritOrb3.oamIndex].attr2 = (((2) & 0xF) <<12) | ((((0) * (32) + (23))) & 0x3FF);
        }
    } else {
        shadowOAM[spiritOrb3.oamIndex].attr0 = (2<<8);
    }
...
void drawChests() {
    ...
    if (chest.active) {
        ...
        if (screenY > 160 || screenX > 240 || screenY < -chest.height || screenX < -chest.width) {
            ...
            shadowOAM[chest.oamIndex].attr2 = (((6) & 0xF) <<12) | ((((tileY) * (32) + (30))) & 0x3FF);
        }
    } else {
        shadowOAM[chest.oamIndex].attr0 = (2<<8);
    }
...
void drawArmor() {
    if (armor.active) {
        ...
        if (screenY > 160 || screenX > 240 || screenY < -armor.height || screenX < -armor.width) {
            ...
            shadowOAM[armor.oamIndex].attr2 = (((7) & 0xF) <<12) | ((((4) * (32) + (30))) & 0x3FF);
        }
    } else {
        shadowOAM[armor.oamIndex].attr0 = (2<<8);
    }
...
void drawMarker() {
    ...
    if (marker.active) {
        ...
        shadowOAM[marker.oamIndex].attr2 = (((2) & 0xF) <<12) | ((((0) * (32) + (25))) & 0x3FF);
    } else {
...
void drawStamina() {
    ...
    if (stamina1.active) {
        ...
        shadowOAM[stamina1.oamIndex].attr2 = (((3) & 0xF) <<12) | ((((0) * (32) + (26))) & 0x3FF);
    } else {
    ...
    if (staminaHold1.active) {
        ...
        shadowOAM[staminaHold1.oamIndex].attr2 = (((3) & 0xF) <<12) | ((((0) * (32) + (28))) & 0x3FF);
    } else {
    ...
    if (stamina2.active) {
        ...
        shadowOAM[stamina2.oamIndex].attr2 = (((3) & 0xF) <<12) | ((((0) * (32) + (26))) & 0x3FF);
    } else {
    ...
    if (staminaHold2.active) {
        ...
        shadowOAM[staminaHold2.oamIndex].attr2 = (((3) & 0xF) <<12) | ((((0) * (32) + (28))) & 0x3FF);
    } else {
    ...
    if (stamina3.active) {
        ...
        shadowOAM[stamina3.oamIndex].attr2 = (((3) & 0xF) <<12) | ((((0) * (32) + (26))) & 0x3FF);
    } else {
    ...
    if (staminaHold3.active) {
        ...
        shadowOAM[staminaHold3.oamIndex].attr2 = (((3) & 0xF) <<12) | ((((0) * (32) + (28))) & 0x3FF);
    } else {
